...
export default function KnowledgeGraphics() {
  return (
    <>
        ...
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            {[
              ...
              <div key={i} className="group flex gap-6 p-7 rounded-3xl bg-gradient-to-br from-[#024AD8]/5 to-[#024AD8]/5 border border-blue-100 hover:border-[#024AD8]/20 hover:shadow-xl transition-all">
                <div className="flex h-16 w-16 shrink-0 items-center justify-center rounded-2xl bg-gradient-to-r from-[#024AD8] to-[#003BA8] text-white text-2xl font-extrabold shadow-lg">
                  {i+1}
                </div>
                <div>
