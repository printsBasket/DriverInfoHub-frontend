  ...
  return (
    <>
              ...
              <ul className="space-y-4">
                {[
                  ...
                  <li key={i} className="flex items-center gap-3">
                    <div className="mt-1 flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-blue-900 text-white">
          ...
          <div className="space-y-6">
            {[
              ...
              <div key={i} className="group flex gap-6 p-6 rounded-3xl bg-white border border-slate-200 hover:border-blue-300 hover:shadow-xl transition-all">
                <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-blue-900 text-white text-xl font-extrabold shadow-lg">
                  {step.num}
                </div>
                <div>
      ...
      <section className="py-10 md:py-14">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 px-6 py-8 text-center shadow-sm md:px-8 md:py-10">
            <div className="absolute inset-0">
              <div className="absolute left-0 top-0 h-48 w-48 rounded-full bg-blue-600/20 blur-3xl" />
            ...
            <div className="relative">
              ...
              <div className="mt-6 flex flex-col items-center justify-center gap-3 sm:flex-row">
                <Link
                  className="inline-flex items-center justify-center rounded-xl bg-gradient-to-r from-blue-600 to-sky-500 px-6 py-3 text-sm font-semibold text-white transition hover:opacity-90"
                  href="/drivers/"
                >
                  Browse all topics
                </Link>
